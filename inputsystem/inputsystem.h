...
public:
        ...
        // Gyroscope public API (called from game/client via IInputSystem,
        virtual bool GetGyroAccumulators( float &pitch, float &yaw );
        void SetGyroAngularVelocity( float pitch_dps, float yaw_dps );
        bool IsGyroAvailable() const { return m_bGyroInitialized; }
...
public:
        ...
        float m_flGyroAngVelPitch; // degrees/second, latest snapshot
        float m_flGyroAngVelYaw;   // degrees/second, latest snapshot
