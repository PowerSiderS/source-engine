...
#if defined( CLIENT_DLL )
ConVar viewmodel_offset_x( "viewmodel_offset_x", "0.0", FCVAR_ARCHIVE, "Viewmodel X offset (left/right)", true, -5.0f, true, 5.0f );
ConVar viewmodel_offset_y( "viewmodel_offset_y", "0.0", FCVAR_ARCHIVE, "Viewmodel Y offset (forward/back)", true, -5.0f, true, 5.0f );
ConVar viewmodel_offset_z( "viewmodel_offset_z", "0.0", FCVAR_ARCHIVE, "Viewmodel Z offset (up/down)", true, -5.0f, true, 5.0f );
#endif
...
void CBaseViewModel::CalcViewModelView( CBasePlayer *owner, const Vector& eyePosition, const QAngle& eyeAngles )
{
        ...
        // Apply viewmodel offset CVars (CS:GO style)
