...
void EventList_RegisterSharedEvents( void )
{
	...
	REGISTER_SHARED_ANIMEVENT( AE_WPN_COMPLETE_RELOAD, AE_TYPE_SERVER );
	REGISTER_SHARED_ANIMEVENT( AE_CL_BODYGROUP_SET_TO_CLIP, AE_TYPE_CLIENT );
	REGISTER_SHARED_ANIMEVENT( AE_CL_BODYGROUP_SET_TO_NEXTCLIP, AE_TYPE_CLIENT );
}