...
public:
    ...
    CNetworkVar( float, m_flVelocityModifier );
        ...
        // Weapon inspection
        bool IsLookingAtWeapon( void ) const { return m_bIsLookingAtWeapon; }
        bool IsHoldingLookAtWeapon( void ) const { return m_bIsHoldingLookAtWeapon; }
...
private:
    ...
    bool    m_bPlayingFreezeCamSound;
        ...
        int             m_nInspectParity;
        int             m_nLastInspectParity;
