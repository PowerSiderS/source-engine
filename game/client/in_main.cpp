...
void IN_LookAtWeaponDown( const CCommand &args ) { engine->ServerCmd( "+lookatweapon" ); }
void IN_LookAtWeaponUp( const CCommand &args ) { engine->ServerCmd( "-lookatweapon" ); }
...
static ConCommand startlookatweapon("+lookatweapon", IN_LookAtWeaponDown);
static ConCommand endlookatweapon("-lookatweapon", IN_LookAtWeaponUp);
static ConCommand startinspect("+inspect", IN_LookAtWeaponDown);
static ConCommand endinspect("-inspect", IN_LookAtWeaponUp);
