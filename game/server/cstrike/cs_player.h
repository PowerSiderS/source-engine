...
public:
    ...
    int GetNumFirearmsUsed() { return m_WeaponTypesUsed.Count(); }
        ...
        void SetAvatarCRC( CRC32_t crc );
        CRC32_t GetAvatarCRC( void ) const;
    ...
    //=============================================================================
        ...
        CRC32_t m_nAvatarCRC; // Avatar VTF CRC (uploaded like spray via sv_allowupload, slot 2)
...
inline CRC32_t CCSPlayer::GetAvatarCRC( void ) const
{
        return m_nAvatarCRC;
}
