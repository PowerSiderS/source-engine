...
public:
    ...
    int GetNumFirearmsUsed() { return m_WeaponTypesUsed.Count(); }
        ...
        void SetAvatarPath( const char *pPath );
        const char *GetAvatarPath( void ) const;
    ...
    //=============================================================================
        ...
        char m_szAvatarPath[MAX_AVATAR_PATH_LENGTH];
...
inline const char *CCSPlayer::GetAvatarPath( void ) const
{
        return m_szAvatarPath;
}
