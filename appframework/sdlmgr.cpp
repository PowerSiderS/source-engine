...
void CSDLMgr::PumpWindowsMessageLoop()
{
        ...
        while ( SDL_PollEvent(&event) && nEventsProcessed < 100 )
        {
                ...
                switch ( event.type )
                {
                        ...
                        {
                                // Android: App returned to foreground
                                // Post app activate event - engine will handle audio restart
                                DevMsg( "SDL_APP_DIDENTERFOREGROUND\n" );
                                m_bHasFocus = true;
                                CCocoaEvent theEvent;
                                theEvent.m_EventType = CocoaEvent_AppActivate;
                                theEvent.m_ModifierKeyMask = 1;
                        ...
                        {
                                // Android: App going to background
                                DevMsg( "SDL_APP_WILLENTERBACKGROUND\n" );
                                m_bHasFocus = false;
                                CCocoaEvent theEvent;
                                theEvent.m_EventType = CocoaEvent_AppActivate;
                                theEvent.m_ModifierKeyMask = 0;
